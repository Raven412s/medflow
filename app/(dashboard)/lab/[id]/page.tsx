                            ...
                            <div key={ri} className="space-y-3">
                                {order.results.length > 1 && (
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm font-medium">{testResult.testName}</span>
                                    </div>
                                )}
                                ...
                                <div className="border rounded-lg overflow-hidden">
                                    <div
                                        className="grid gap-3 px-4 py-2 bg-muted/50 text-xs font-medium text-muted-foreground"
                                        style={{ gridTemplateColumns: "80px 1fr 100px 130px 80px" }}
                                    >
                                        <span>Code</span>
                                        <span>Parameter</span>
                                        <span>Value</span>
                                    ...
                                    {testResult.parameterResults.map((param, pi) => (
                                        <div
                                            key={pi}
                                            className={cn(
                                                "grid gap-3 px-4 py-2.5 border-t text-sm items-center",
                                                param.isAbnormal && "bg-red-50/60"
                                            )}
                                            style={{ gridTemplateColumns: "80px 1fr 100px 130px 80px" }}
                                        >
                                ...
                                {ri < order.results.length - 1 && <Separator />}
                            </div>
                        )
                    )}
